<div class="span9">
    ...
    <form method='POST' action='/dashboard/p_add' id="addVideo">
        ...
        <div class="ghost"><div class="alert alert-error">Sorry, this doesn't look like a valid Youtube URL. We only support Youtube videos at this time, but
        hope to add more formats soon!
        </div>
        </div>
