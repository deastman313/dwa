<html>
	...
	*= <?php $var2 *=4; echo $var2;?><br>
	...
	<br>
	Absolute value: abs (0-300) -- "Zero minus three hundred and returns the absolute value"<br>
	Exponential: pow(2,8) -- "Two to the eighth power"<br>
	Square root: sqrt(100) -- "Square root of one hundred"<br> 
